...
and consuming reusable, and navible REST APIs built on the Java platform.

== Installing HalBuilder

HalBuilder is distributed via Maven Central, and the simplest way to get started is to include the `halbuilder-standard` dependency:
